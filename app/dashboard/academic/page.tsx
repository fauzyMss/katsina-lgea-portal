    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-green-800 text-white px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <span className="text-sm">HOD Academic</span>
      ...
      <div className="flex">
        <aside className="w-64 min-h-screen bg-white shadow p-4">
          {['Dashboard','School Academic Data','Teacher Qualifications','Subject Coverage','Academic Reports','Announcements'].map((item) => (
        ...
        <main className="flex-1 p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">HOD Academic Dashboard</h1>
          <p className="text-gray-500 text-sm mb-6">Academic Department — School & Teacher Data</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              ...
              {label:'Qualified Teachers',value:'0',bg:'bg-purple-50',border:'border-purple-200'},
              {label:'Subject Gaps',value:'0',bg:'bg-red-50',border:'border-red-200'},
            ].map((s) => (
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {[
              {label:'NCE Holders',value:'0',bg:'bg-blue-50',border:'border-blue-200'},
              {label:'B.Ed Holders',value:'0',bg:'bg-green-50',border:'border-green-200'},
              {label:'PGDE Holders',value:'0',bg:'bg-purple-50',border:'border-purple-200'},
            ].map((s) => (
              <div key={s.label} className={`${s.bg} border ${s.border} rounded-xl p-4`}>
                <p className="text-3xl font-bold text-gray-800">{s.value}</p>
                <p className="text-sm text-gray-500 mt-1">{s.label}</p>
