    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-green-800 text-white px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <span className="text-sm">HOD Finance</span>
      ...
      <div className="flex">
        <aside className="w-64 min-h-screen bg-white shadow p-4">
          {['Dashboard','Salary Slips','Payroll Records','Salary Complaints','Generate Reports','Announcements'].map((item) => (
        ...
        <main className="flex-1 p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">HOD Finance Dashboard</h1>
          <p className="text-gray-500 text-sm mb-6">Finance Department — Salary & Payroll</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {[
              {label:'Total Staff',value:'0',bg:'bg-blue-50',border:'border-blue-200'},
              {label:'Salary Slips Uploaded',value:'0',bg:'bg-green-50',border:'border-green-200'},
              {label:'Salary Complaints',value:'0',bg:'bg-red-50',border:'border-red-200'},
              {label:'Pending Payroll',value:'0',bg:'bg-yellow-50',border:'border-yellow-200'},
            ].map((s) => (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                {label:'Upload Salary Slips',color:'bg-green-600'},
                {label:'View Payroll Records',color:'bg-blue-600'},
                {label:'Generate Payroll Report',color:'bg-purple-600'},
              ].map((a) => (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6">
            <h2 className="font-semibold text-gray-700 mb-4">Salary Complaints</h2>
            <div className="text-center py-8 text-gray-400">
              <p className="text-4xl mb-2">📭</p>
              <p className="text-sm">No salary complaints yet</p>
            </div>
          </div>
